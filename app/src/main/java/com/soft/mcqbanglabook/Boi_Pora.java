...
public class Boi_Pora extends AppCompatActivity implements View.OnClickListener {
    ...
    int score= 0;
    int totalQuestion = BoiPora_QNA.myQuestion.length;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.boi_pora);
...
*/
    ...
    public void onClick(View view) {
        ...
        if(clickedButton.getId()==R.id.submit_btn){
            if(selectedAnswer.equals(BoiPora_QNA.myCorrectAnswer[currentQuestionIndex])){
                score++;
            }
